"""
Django settings for generic_website_api project.
...
SECRET_KEY = 't9d_-l41(#yxx+qo)83$o!&x6s7ek7ca02u+f09a8u)lig9=d3'
...
ROOT_URLCONF = 'generic_website_api.urls'
...
WSGI_APPLICATION = 'generic_website_api.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'generic_website_api',  # 数据库名字
        'USER': 'root',  # 账号
        'PASSWORD': '123456',  # 密码
        'HOST': '127.0.0.1',  # IP
        'PORT': '3306',  # 端口
